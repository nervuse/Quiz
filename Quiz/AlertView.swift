...
class AlertView: UIView {
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([topImageConstraint, centerXImageConstraint, heightImageConstraint, widthImageConstraint])
        ...
        NSLayoutConstraint.activate([topTitleLabelConstraint, leadingTitleLabelConstraint, trailingTitleLabelConstraint, heightTitleLabelConstraint])
        ...
        NSLayoutConstraint.activate([topMessageLabelConstraint, leadingMessageLabelConstraint, trailingMessageLabelConstraint, heightMessageLabelConstraint])
